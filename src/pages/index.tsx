...
const Home: React.FC = () => {
    const images = [
        { id: 'breastfeeding1', src: '/images/breastfeeding1.jpg', likes: 0, likedBy: new Set<string>() },
        { id: 'breastfeeding2', src: '/images/breastfeeding2.jpg', likes: 0, likedBy: new Set<string>() },
        { id: 'breastfeeding3', src: '/images/breastfeeding3.jpg', likes: 0, likedBy: new Set<string>() },
        { id: 'breastfeeding4', src: '/images/breastfeeding4.jpg', likes: 0, likedBy: new Set<string>() },
        { id: 'breastfeeding5', src: '/images/breastfeeding5.jpg', likes: 0, likedBy: new Set<string>() },
        { id: 'breastfeeding6', src: '/images/breastfeeding6.jpg', likes: 0, likedBy: new Set<string>() },
        { id: 'breastfeeding7', src: '/images/breastfeeding7.jpg', likes: 0, likedBy: new Set<string>() },
        { id: 'breastfeeding8', src: '/images/breastfeeding8.jpg', likes: 0, likedBy: new Set<string>() },
        { id: 'breastfeeding9', src: '/images/breastfeeding9.jpg', likes: 0, likedBy: new Set<string>() },
        { id: 'breastfeeding10', src: '/images/breastfeeding10.jpg', likes: 0, likedBy: new Set<string>() },
    ];
    ...
    const handleLike = async (index: number) => {
        ...
        try {
            const response = await fetch(`http://localhost:4000/api/likes/${newImageStates[index].id}/like`, {
                method: 'POST',
            ...
            if (!response.ok) {
                ...
                throw new Error(`Error liking image: ${errorData.message}`);
            }
